...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LatestEntriesPlugin.split'
        db.add_column(u'cmsplugin_latestentriesplugin', 'split',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LatestEntriesPlugin.split'
        db.delete_column(u'cmsplugin_latestentriesplugin', 'split')
    ...
    models = {
        ...
        u'cmsplugin_zinnia.latestentriesplugin': {
            ...
            'split': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
